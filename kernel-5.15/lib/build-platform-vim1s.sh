...
[ -e $PLATFORM/vims-5.15/boot/dtb/amlogic/kvim1s.dtb.overlays ] && rm -r $PLATFORM/vims-5.15/boot/dtb/amlogic/kvim1s.dtb.overlays
dpkg-deb -R $PLATFORM/kernel-5.15/khadas/debs/${DEVICE}/khadas-vim1s-linux-5.4-dt-overlays_*.deb /tmp/khadas-dt-overlays
